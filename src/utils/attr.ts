export const styleData: { key: string; label: string }[] = [
  { key: "left", label: "x 坐标" },
  { key: "top", label: "y 坐标" },
...
export const textAlignOptions: { label: string; value: string }[] = [
  {
    label: "左对齐",
    value: "left",
  },
...
export const borderStyleOptions: { label: string; value: string }[] = [
  {
    label: "实线",
    value: "solid",
  },
...
export const verticalAlignOptions:{ label: string; value: string }[] = [
  {
      label: '上对齐',
      value: 'top',
  },
